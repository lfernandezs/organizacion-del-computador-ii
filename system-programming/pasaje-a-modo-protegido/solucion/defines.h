...
#define GDT_CODE_0_SEL ((GDT_IDX_CODE_0 << 3) | (0x1) | (0x0))
#define GDT_DATA_0_SEL ((GDT_IDX_DATA_0 << 3) | (0x1) | (0x0))
#define GDT_CODE_3_SEL ((GDT_IDX_CODE_3 << 3) | (0x1) | (0x3))
#define GDT_DATA_3_SEL ((GDT_IDX_DATA_3 << 3) | (0x1) | (0x3))
